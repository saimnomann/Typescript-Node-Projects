...
constructor(firstName:string,lastName:string,age:number,pin:number,Gender:string,mobileNumber:number,userId:number){
...
displayInfo(currentUser:number|Customer){
